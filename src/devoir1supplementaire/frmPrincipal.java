...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void btnNbAnneesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNbAnneesMouseClicked
        ...
        lblNbSemaines.setText(String.valueOf(i));
    ...
    private void btnTriangleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTriangleMouseClicked
        ...
        // A vous de jouer
         DefaultTableModel dtm= (DefaultTableModel) tblTriangle.getModel();
          ...
          x=Integer.parseInt(txtNb.getText())-1;
          j=1;
          while(i<Integer.parseInt(txtNb.getText())){
            k=0;
            while(k<x){
                 v.add("");
                k=k+1;        
    ...
    private void btnCalculerPrimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCalculerPrimeMouseClicked
        ...
        if(txtNbBugs.getText().compareTo("")==0){
            JOptionPane.showMessageDialog(this, "veuillez saisir le nombre de beug corrigés");
        }
                if(txtNbAnnees.getText().compareTo("")==0){
            JOptionPane.showMessageDialog(this, "veuillez saisir le nombre d'années");
        }
       else{
            prix_bugs=0.04*Integer.parseInt(txtNbBugs.getText());
            if(prix_bugs>400){
                prix_bugs=400;
            }
                    
            i=0;
            while(i<Integer.parseInt(txtNbAnnees.getText())+1){
                 if(i<=4){
                     prix_anne=300;
                 }
                 else if(i>4){
                     prix_anne=prix_anne+30;
                 }
            ...
            prix_total=prix_anne+prix_bugs;
            lblPrime.setText(String.valueOf(prix_total));
...
double prix_bugs,prix_anne,prix_total, cumul,prix,reduc ;
int i,j,k,x;
String etoile,esp;
